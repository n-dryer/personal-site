...
>(({ className, sideOffset = 8, ...props }, ref) => (
  <TooltipPrimitive.Content
    ...
    className={cn(
      'z-50 overflow-hidden rounded-xl border border-resume-card-border bg-resume-card/95 px-3 py-2 text-sm text-resume-text-primary shadow-2xl ring-1 ring-resume-ring/40 backdrop-blur-xl',
